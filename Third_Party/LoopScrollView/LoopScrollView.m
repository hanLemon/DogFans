...
-(instancetype)initWithFrame:(CGRect)frame WithLocalImages:(NSArray *)imageArray WithLocalLabels:(NSArray *)LabelsArray
{
    ...
    if ( self) {
        ...
        if (LabelsArray) {
            ...
            [self setLabelArray:LabelsArray];
...
- (void)initImageView {
    ...
    UILabel *leftLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, ScrollHeight *0.7, ScrollWidth, ScrollHeight * 0.2)];
    leftLabel.textColor = [UIColor whiteColor];
    UILabel *centerLabel = [[UILabel alloc] initWithFrame:CGRectMake(10 + ScrollWidth, ScrollHeight * 0.7 , ScrollWidth, ScrollHeight * 0.2)];
        centerLabel.textColor = [UIColor whiteColor];
    UILabel *rightLabel = [[UILabel alloc] initWithFrame:CGRectMake(10 + 2*ScrollWidth, ScrollHeight *0.7, ScrollWidth, ScrollHeight * 0.2)];
...
{
    if (_isNetworkImage) {
        [self.delagate didSelectedNetImageAtIndex:_currentIndex];
    }
    else{
       [self.delagate didSelectedLocalImageAtIndex:_currentIndex];
    }
...
//        pageControl.frame = CGRectMake(ScrollWidth - 150,ScrollHeight - pageSize,150, 8);
    
         pageControl.frame  = CGRectMake(0,ScrollHeight - pageSize,ScrollWidth, 8);
...
- (void)changeImageLeft:(NSInteger)LeftIndex center:(NSInteger)centerIndex right:(NSInteger)rightIndex
{
    ...
    }else
    {
        ...
        // 给label.text赋值
        _leftLabel.text = _labelArray[LeftIndex];
        _centerLabel.text = _labelArray[centerIndex];
        _rightLabel.text = _labelArray[rightIndex];
    }
